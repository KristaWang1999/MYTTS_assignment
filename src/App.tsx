      ...
      <main className="max-w-4xl mx-auto px-6 py-12 space-y-12">
        ...
        <div className="space-y-16">
          {QUESTIONS.map((q, index) => (
            <section key={q.id} className="bg-white p-8 rounded-2xl border border-zinc-200 shadow-sm hover:shadow-md transition-shadow group">
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center w-14 h-14 rounded-full transition-all ${
                      playingId === q.id
                        ...
                        : 'bg-red-600 text-white hover:bg-red-700 shadow-lg shadow-red-200 hover:scale-105 active:scale-95'
                    }`}
                    title="Play Audio"
                  >
                    {playingId === q.id ? (
